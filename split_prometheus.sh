#!/bin/bash
# 拆分 PrometheusMetricsCollector.cs

# 创建 NullMetricsCollector 独立文件
cat > src/Services/Monitoring/NullMetricsCollector.cs << 'NULLEOF'
...
echo "✅ PrometheusMetricsCollector.cs 拆分完成"
