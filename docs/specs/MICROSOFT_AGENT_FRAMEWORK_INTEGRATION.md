...
1. **[09-implementation-guide.md](docs/specs/09-implementation-guide.md)**
   - 更新包引用：`Microsoft.AgentFramework` → `Microsoft.Agents.AI`
   - 更新版本号：`1.0.0-preview` → `1.0.0-preview.251001.1`

2. **[11-implementation-roadmap.md](docs/specs/11-implementation-roadmap.md)**
   - 更新 Core 项目包引用配置
   - 反映实际的 MS AF 集成状态

3. **[12-layered-architecture.md](docs/specs/12-layered-architecture.md)**
   - 更新外部依赖说明
   - 明确包名和版本号
